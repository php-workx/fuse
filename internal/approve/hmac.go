...
func SignApproval(secret []byte, id, decisionKey string) string {
...
func VerifyApproval(secret []byte, id, decisionKey, mac string) bool {
	expected := SignApproval(secret, id, decisionKey)
